...
class TechnologiesControllerTest < ActionController::TestCase
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post :create, technology: { description: @technology.description, doc: @technology.doc, link: @technology.link, logo: @technology.logo, name: @technology.name }
    end
  ...
  test "should update technology" do
    patch :update, id: @technology, technology: { description: @technology.description, doc: @technology.doc, link: @technology.link, logo: @technology.logo, name: @technology.name }
    assert_redirected_to technology_path(assigns(:technology))
  end
