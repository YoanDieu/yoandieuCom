...
class FormationsControllerTest < ActionController::TestCase
  ...
  test "should create formation" do
    assert_difference('Formation.count') do
      post :create, formation: { certificate: @formation.certificate, enddate: @formation.enddate, institution: @formation.institution, name: @formation.name, skills: @formation.skills, startdate: @formation.startdate, url: @formation.url }
    end
  ...
  test "should update formation" do
    patch :update, id: @formation, formation: { certificate: @formation.certificate, enddate: @formation.enddate, institution: @formation.institution, name: @formation.name, skills: @formation.skills, startdate: @formation.startdate, url: @formation.url }
    assert_redirected_to formation_path(assigns(:formation))
  end
